                                    ...
                                    <a href="#">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="noti-details"><span class="noti-title">Carlson
                                                        Tech</span> has approved <span class="noti-title">your
                                                        estimate</span></p>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="noti-details"><span class="noti-title">John
                                                        Hendry</span> sent a cancellation request <span
                                                        class="noti-title">Apple iPhone XR</span></p>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="noti-details"><span class="noti-title">Mercury Software
                                                        ...
                                                        class="noti-title">Apple MacBook Pro</span></p>
                            ...
                            <div class="card-body">
                                <ul class="activity-feed">
                                    <li class="feed-item">
                                        ...
                                        <span class="feed-text"><a>John Doe</a> won 1st place in
                                            <a>"Chess"</a></span>
                                    </li>
                                    <li class="feed-item">
                                    ...
                                    <li class="feed-item">
                                        ...
                                        <span class="feed-text"><a>Justin Lee</a>attended internation conference
                                            in <a href="profile.html">"St.John School"</a></span>
                                    </li>
                                    <li class="feed-item">
                                        <div class="feed-date">Apr 13</div>
                                        <span class="feed-text"><a>John Doe</a> won 1st place in
