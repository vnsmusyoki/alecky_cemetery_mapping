        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                    <p><span class="badge badge-dange">{{ $users->count() }} </span>Search Results for <span
                            class="badge badge-success">{{ $name }}</span> found</p>
                                            ...
                                            <div class="media">
                                                <a class="pull-left"
                                                    ...
                                                    <img class="media-object"
                                                        src="{{ asset('storage/pictures/' . $user->picture) }}"  style="max-height:150px;"
                                                        alt="details1">
                                                </a>
                                                <div class="media-body">
                                                    ...
                                                    <p><i aria-hidden="true"
                                                            class="fa fa-calendar"></i>Date of Burial - {{ $user->burial_date }}</p>
                                                    <p>{{ $user->eulogy }}</p>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="inner-our-obituaries-box">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h3 class="media-heading"><a href="#">No Results Found for this search</a></h3>
